...
logging.basicConfig(filename='semanticsimilarity.log',level=logging.INFO, format=LOG_FORMAT)
...
#            (1.0 - DELTA) * word_order_similarity(sentence_1, sentence_2)
    ...
    right_now = datetime.datetime.now().strftime("%Y-%B-%d %I:%M %p")
    logging.info("{}-->{} seconds for matching of {} {}".format(right_now, (t1-t0)/100, sentence_1, sentence_2))
    return value
